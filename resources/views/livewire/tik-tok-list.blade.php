<div class="min-h-screen text-white bg-gradient-to-br from-gray-900 to-gray-800">
    <div class="container px-4 py-8 mx-auto">
        ...
        <div class="mb-8 text-center">
            <h1 class="mb-2 text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">
                My TikTok Videos
            </h1>
        ...
        <div class="flex items-center justify-end mb-8">
            <select wire:model.live="filter" class="px-4 py-2 text-gray-300 border-0 rounded-lg bg-white/5 backdrop-blur-sm focus:ring-2 focus:ring-purple-500">
        ...
        @else
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                @foreach ($videoProjects as $project)
                    <div class="overflow-hidden transition-all duration-200 rounded-xl bg-white/5 backdrop-blur-sm hover:bg-white/10">
                        ...
                        <div class="p-6">
                            <div class="flex items-start justify-between">
                                <h3 class="flex-1 mb-2 text-lg font-semibold text-gray-300">
                                    {{ Str::limit($project->title, 50) }}
                                </h3>
                                <span class="px-2 py-1 ml-2 text-xs font-medium rounded-full whitespace-nowrap
