...
<section>
    ...
    <form wire:submit="updateProfileInformation" class="mt-6 space-y-6">
                ...
                <div>
                    <p class="mt-2 text-sm text-gray-400">
                        ...
                        <button wire:click.prevent="sendVerification"
                            class="text-sm text-purple-400 underline rounded-md hover:text-purple-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">
        ...
        <div class="flex items-center gap-4">
            ...
            <x-action-message class="text-green-400 me-3" on="profile-updated">
                {{ __('Saved.') }}
            </x-action-message>
        </div>
    </form>
